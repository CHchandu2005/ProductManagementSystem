...
//   // ✅ Build filters dynamically and fetch products
...
//         order: sortBy === 'low-to-high' ? 'asc' : sortBy === 'high-to-low' ? 'desc' : undefined,
//         page: currentPage,
//         limit,
//       };
//       await loadProducts(filters);
//     },
//     [selectedCategories, sortBy, searchTerm, page, limit, loadProducts]
//   );
...
//                   <button onClick={goPrev} disabled={page <= 1} className={styles.addButton} style={{ padding: '8px 12px', display: 'flex', alignItems: 'center', gap: '6px' }} aria-label="Previous page">
//                     <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" width="18" height="18" aria-hidden="true">
//                       <path fillRule="evenodd" d="M12.78 15.22a.75.75 0 01-1.06 0l-5-5a.75.75 0 010-1.06l5-5a.75.75 0 111.06 1.06L8.06 10l4.72 4.72a.75.75 0 010 1.06z" clipRule="evenodd" />
//                     </svg>
//                     {/* <span>Previous</span> */}
//                   </button>
...
//                       </button>
//                     ))}
//                   <button onClick={goNext} disabled={page >= totalPages} className={styles.addButton} style={{ padding: '8px 12px', display: 'flex', alignItems: 'center', gap: '6px' }} aria-label="Next page">
//                     {/* <span>Next</span> */}
//                     <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" width="18" height="18" aria-hidden="true">
//                       <path fillRule="evenodd" d="M7.22 4.78a.75.75 0 011.06 0l5 5a.75.75 0 010 1.06l-5 5a.75.75 0 11-1.06-1.06L11.94 10 7.22 5.28a.75.75 0 010-1.06z" clipRule="evenodd" />
//                     </svg>
//                   </button>
//                 </div>
...
const ProductListPage = ({ onLogout }) => {
  ...
  // ✅ Consolidated single effect (debounced)
  useEffect(() => {
    const timeoutId = setTimeout(() => {
      const filters = {
        search: searchTerm.trim() || undefined,
